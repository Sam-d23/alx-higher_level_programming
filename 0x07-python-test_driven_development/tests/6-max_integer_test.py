...
class TestMaxInteger(unittest.TestCase):
    ...
    def test_no_args(self):
        """Testing no arguments passed to func"""
    ...
    def test_positive_end(self):
        """Testing all positive with max at end"""
        e = [2, 10, 8, 36, 14, 50]
        self.assertEqual(max_integer(e), 50)

    def test_positive_middle(self):
        """Testing all positive with max in middle"""
        m = [2, 10, 8, 360, 14, 50]
        self.assertEqual(max_integer(m), 360)

    def test_positive_beginning(self):
        """Testing all positive with max at beginning"""
        b = [200, 10, 8, 36, 14, 50]
    ...
    def test_none(self):
        """Tests passing none as argument"""
